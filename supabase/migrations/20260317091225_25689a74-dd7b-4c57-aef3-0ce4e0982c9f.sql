...
ADD COLUMN IF NOT EXISTS banned_for_game boolean NOT NULL DEFAULT false;
...
BEGIN
  ...
  IF v_price IS NULL THEN
    RETURN QUERY SELECT false, 0, 0::numeric, 0::numeric, 'Buying is closed or prize pot is not set';
    RETURN;
  END IF;
